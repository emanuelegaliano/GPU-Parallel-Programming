...
Queste dispense sono nate come appunti personali per il corso di \emph{\BookTitle -- \BookSubtitle} tenuto presso il Dipartimento di Matematica e Informatica dell'Universit\`a di Catania tenuto dal Prof. Giuseppe Bilotta nell'anno accademico \BookAY. L'obiettivo principale di questo materiale è stato fornire una risorsa personale di studio sulla parte teorica del corso, raggruppando concetti chiave, definizioni, teoremi, immagini ed esempi in unico documento. 
...
\centering
\url{https://github.com/emanuelegaliano/GPU-Parallel-Programming}
\end{minipage}
\end{center}
