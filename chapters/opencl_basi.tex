...
Per questo motivo è necessario garantire che la memoria coinvolta nel trasferimento rimanga stabile per tutta la durata dell’operazione. Questo si ottiene tramite il \emph{pinning}, ovvero bloccando (page-locking) le pagine di memoria dell’host in modo che non possano essere spostate dal sistema operativo.
